...
Usage: check_patch.py -p [/path/to/patch]
       ...
       check_patch.py --full --yes [check all the autotest-client-tests tree]
...
try:
    ...
    import virt.virttest.common as common
...
if __name__ == "__main__":
    ...
    if full_check:
        ...
        logging.info("autotest-client-tests full tree check")
        logging.info("")
