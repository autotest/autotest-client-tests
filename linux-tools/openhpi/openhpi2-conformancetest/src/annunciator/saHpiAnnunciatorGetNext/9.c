...
/*************************************************************************
 *
 * If there are no announcements in the Annunciator with a given severity,
 * then the first call to saHpiAnnunciatorGetNext() should return
 * NOT_PRESENT.
 *
 *************************************************************************/
 ...
 * the announcements in the Annunciator.  If we find one, then use it
 * for test 1.  If we don't find one, then we will run test 2.
 *
 *************************************************************************/
