...
/*************************************************************************
 *
 * Read all of the fields for an Area with a FieldType of MANUFACTURER.
 * We will only pass if there is one or more fields and we don't encounter 
 * any errors.  If there are no fields, simply return NOTSUPPORT since we 
 * can't say for sure that the function is working correctly.
 *
 *************************************************************************/
