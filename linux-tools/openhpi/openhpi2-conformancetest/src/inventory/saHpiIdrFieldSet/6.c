...
/*************************************************************************
 *
 * Test an invalid area id.  Since we need to use a valid Field,
 * we will use one of the fields belonging to a real Area.  Since we are
 * using an invalid area id, there should be no danger in setting
 * that field.
 *
 *************************************************************************/
 ...
 * we find an Area that has a Field.
 *
 *************************************************************************/
