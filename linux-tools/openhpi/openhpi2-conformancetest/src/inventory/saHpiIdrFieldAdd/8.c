...
/*************************************************************************
 *
 * Try adding a field to a read-only IDR.  Note that it is possible for other
...
/*************************************************************************
 *
 * Try adding a Field to a read-only IDR.
 * If we can't find any read-only IDRs, we will return NOTSUPPORT.
 *
 *************************************************************************/
