...
/*************************************************************************
 *
 * Test an invalid AreaId.  Note that it is possible for other
 ...
 * invalid AreaId.  If we can't find any Areas that we can write
