...
/*************************************************************************
 *
 * Try adding a field using NULL for the Field parameter.  Note that it is 
 * possible for other error codes to be returned.  If that occurs, we will 
 * return NOTSUPPORT since it is legal to return other error codes.  
 *
 *************************************************************************/
	     ...
	     SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	status = saHpiIdrFieldAdd(sessionId, resourceId, IdrId, NULL);
...
/*************************************************************************
 *
 * Try adding a Field using NULL for the Field parameter.
