...
/*************************************************************************
 *
 * Try adding a field using an invalid FieldType.  Note that it is possible 
	     ...
	     SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	Field.Type = SAHPI_IDR_FIELDTYPE_CUSTOM + 1;
...
/*************************************************************************
 *
 * Try adding a Field using an invalid field type.
