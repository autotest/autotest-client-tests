...
/*************************************************************************
 *
 * Try adding a field using an invalid language.  Note that it is possible 
	     ...
	     SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	Field.FieldId = 0;
	Field.Field.Language = SAHPI_LANG_ZULU + 1;
	Field.AreaId = AreaId;
...
/*************************************************************************
 *
 * Try adding a Field using an invalid language.
