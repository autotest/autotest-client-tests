...
/*************************************************************************
 *
 * Try adding a field to a read-only Area.  Note that it is possible for other
	     ...
	     SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	if (status == SA_ERR_HPI_INVALID_DATA) {
		...
		e_print(saHpiIdrFieldAdd, SA_ERR_HPI_READ_ONLY, status);
	}
...
/*************************************************************************
 *
 * For Areas that are read-only, try adding a Field.
 * If we can't find any Areas that are read-only, we will return NOTSUPPORT.
 *
 *************************************************************************/
