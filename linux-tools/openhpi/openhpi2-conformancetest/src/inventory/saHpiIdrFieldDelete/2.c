 ...
 * are testing an invalid session id.  There should be no way for the
		...
		SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	if (status == SA_ERR_HPI_NOT_PRESENT) {
		...
		status = saHpiIdrFieldDelete(INVALID_SESSION_ID,
					     resourceId,
 ...
 * the ReadOnly flags.  Since we are testing an invalid session id,
