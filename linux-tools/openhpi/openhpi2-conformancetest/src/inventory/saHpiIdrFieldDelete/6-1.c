 ...
 * in the Area.  We don't need to worry about it's deletion since we
 * are testing an invalid area id.  There should be no way for the
 ...
 * the Area ReadOnly flag.  Since we are testing an invalid area id,
