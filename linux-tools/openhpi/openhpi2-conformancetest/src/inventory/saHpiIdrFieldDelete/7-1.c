...
/*************************************************************************
 *
 * Try deleting a Field that is ReadOnly.  
 *
 *************************************************************************/
		...
		SaHpiIdrIdT IdrId, SaHpiEntryIdT AreaId)
{
	...
	response =
	    findReadOnlyField(sessionId, resourceId, IdrId, AreaId, &Field);
 ...
 * Area with at least one ReadOnly Field.
 *
 *************************************************************************/
