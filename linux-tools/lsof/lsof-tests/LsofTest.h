...
/* 
 * RCP (RC Paulsen, <rpaulsen@us.ibm.com>)
...
/*
 * $Id: LsofTest.h,v 1.1 2011/12/13 09:45:12 rajuchak Exp $
 */
...
#define	LT_DEF_LSOF_PATH	"/usr/sbin/lsof"	/* Gaurav changed from "/usr/bin/lsof" */
